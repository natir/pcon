 ...
 * It's safe
 */
void pcon_counter_free(struct Counter *counter);
 ...
 */
void pcon_counter_count_fasta(struct Counter *counter,
                              const char *c_path,
 ...
 */
void pcon_counter_inc(struct Counter *counter, uint64_t kmer);
 ...
 */
void pcon_counter_inc_canonic(struct Counter *counter, uint64_t kmer);
 ...
 */
Count pcon_counter_get(const struct Counter *counter, uint64_t kmer);
 ...
 */
Count pcon_counter_get_canonic(const struct Counter *counter, uint64_t kmer);
 ...
 */
void pcon_serialize_counter(const struct Counter *counter, const char *c_path, enum IO *io_error);
 ...
 */
void pcon_deserialize_counter(struct Counter *counter, const char *c_path, enum IO *io_error);

/**
 * Create a new Solid. In python binding Solid is an object, new is the default constructor.
 * See [solid::Solid::new]
 */
struct Solid *pcon_solid_new(uint8_t k);
 ...
 */
struct Solid *pcon_solid_from_counter(const struct Counter *counter, Count abundance);
 ...
 * It's safe
 */
void pcon_solid_free(struct Solid *solid);
 ...
 * See [solid::Solid::set].
 */
void pcon_solid_set(struct Solid *solid, uint64_t kmer, bool value);
 ...
 */
void pcon_solid_set_canonic(struct Solid *solid, uint64_t kmer, bool value);
 ...
 * See [solid::Solid::get].
 */
bool pcon_solid_get(struct Solid *solid, uint64_t kmer);
 ...
 */
bool pcon_solid_get_canonic(struct Solid *solid, uint64_t kmer);
 ...
 */
void pcon_serialize_solid(const struct Solid *solid, const char *c_path, enum IO *io_error);
 ...
 */
void pcon_deserialize_solid(struct Solid *solid, const char *c_path, enum IO *io_error);
 ...
 */
void pcon_dump_csv(const struct Counter *counter,
                   Count abundance,
                   const char *c_path,
                   enum IO *io_error);
 ...
 */
void pcon_dump_solid(const struct Counter *counter,
                     Count abundance,
                     const char *c_path,
                     enum IO *io_error);
 ...
 */
void pcon_dump_spectrum(const struct Counter *counter, const char *c_path, enum IO *io_error);
